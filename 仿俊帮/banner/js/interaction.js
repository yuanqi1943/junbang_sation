...
var shownSection1 = body.querySelector("#sections-wrapper");
...
window.onload = function(){
		var timeDown = setInterval(function(){
			if(shownSection.nextElementSibling && animationSettings.running === false) {
				animationSettings.running = true;
				animateSegments(shownSection.nextElementSibling, false);
			}else if(!shownSection.nextElementSibling && animationSettings.running === false){
				animationSettings.running = true;
				animateSegments(shownSection1.firstElementChild, false);
			}
			// onmouseover=function(){clearInterval(timeDown);console.log(1)}
			// onmouseout=function(){setInterval(timeDown);console.log(2)}
		}, 5000);
}
